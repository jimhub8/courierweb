                                ...
                                <v-layout wrap>
                                    ...
                                    <v-flex sm6>
                                        ...
                                        <div>
                                            <v-layout wrap row>
                                                <v-flex xs6 sm6>
                                                    <v-text-field disabled v-model="user.name" color="blue darken-2" label="Sender name" required></v-text-field>
                                                </v-flex>
                                                <!-- </div> -->
                                                <v-flex xs6 sm6>
                                                    <v-text-field disabled v-model="user.email" color="blue darken-2" label="Sender Email" required></v-text-field>
                                                </v-flex>
                                                <v-flex xs6 sm6>
                                                    <v-text-field disabled v-model="user.address" color="blue darken-2" label="Sender Address" required></v-text-field>
                                                </v-flex>
                                                <v-flex xs6 sm6>
                                                    <v-text-field disabled v-model="user.city" color="blue darken-2" label="Sender City" required></v-text-field>
                                                </v-flex>
                                                <v-flex xs6 sm6>
                                                    <v-text-field disabled v-model="user.phone" color="blue darken-2" label="Sender Phone" required></v-text-field>
                                                </v-flex>

                                                <v-flex xs6 sm6>
                                                    <v-text-field disabled v-model="user.country" color="blue darken-2" label="Country" required></v-text-field>
                                                </v-flex>
                                            </v-layout>
                                        </div>
                                    </v-flex>
...
export default {
    props: ["adddialog", "user", 'role', 'Allcustomer', 'AllDrivers', 'AllBranches'],
    components: {
        barcode: VueBarcode
    },
    data() {
