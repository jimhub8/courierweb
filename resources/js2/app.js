...
// import Dashboard from './components/admin/app.vue';
...
const app = new Vue({
    ...
    components: {
        ...
        myHeader, myFooter, myHeader1, mySubscribers,
        myRinder, myShipment, myProfile, myadminHeader,
        //  myUser, myRoles, Dashboard
