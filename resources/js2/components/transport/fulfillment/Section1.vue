        ...
        <div class="vc_column-inner vc_custom_1458316101338">
            <div class="wpb_wrapper">
                <div class="wpb_text_column wpb_content_element vc_custom_1459356516994 animate anim-fadeIn animate-delay-0 animated fadeIn">
                    <div class="wpb_wrapper">
                        <p style="margin-bottom: 33px;"><span style="color: #0ba6dd; font-size: 36px;"><strong>Fulfilling Multiple e-Commerce Products</strong></span></p>
                        <p style="color: #a4a4a4; font-size: 15px;">Boxleo Courier & Fulfillment Services Ltd. has grown to accommodate the fulfillment of a variety of products including:</p>

                        <ul style="font-weight: 600;color: #0ba6dd;list-style-type: circle;font-size: 15px;">
                            <li><span style="color: #858585; font-weight: 500;list-style-type: none;">Vitamins, Supplements, and Nutraceuticals</span></li>
                            <li><span style="color: #858585; font-weight: 500;">Beauty/Skincare</span></li>
                            <li><span style="color: #858585; font-weight: 500;">Nutritional and Sports Beverages</span></li>
                            <li><span style="color: #858585; font-weight: 500;list-style-type: none;">Media/Books</span></li>
                            <li><span style="color: #858585; font-weight: 500;list-style-type: none;">Apparel</span></li>
                            <li><span style="color: #858585; font-weight: 500;list-style-type: none;">Small Electronics</span></li>
                            <li><span style="color: #858585; font-weight: 500;list-style-type: none;">Plus much more</span></li>
                        </ul>
                    </div>
                </div>
                <div class="vc_row wpb_row vc_inner vc_row-fluid">
                    ...
                    </div><div class="animate anim-fadeIn animate-delay-0-75 wpb_column vc_column_container vc_col-sm-3 animated fadeIn">
                        <div class="vc_column-inner vc_custom_1459356537906">
                            <div class="wpb_wrapper">
                                <div class="icon-list center-block big">
                                    <div class="icon-list-icon" style="border-color:#0ba6dd;color:#0ba6dd;"><i class="fa fa-bars"></i></div>
                                </div>
                                <h2 style="font-size: 13px;color: #a4a4a4;text-align: center" class="vc_custom_heading vc_custom_1459006227460">SHIP</h2>
                            </div>
                        </div>
                    </div>
