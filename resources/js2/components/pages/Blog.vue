                            ...
                            <article v-for="blog in blogs.data" :key="blog.id" id="post-1187" class="post-1187 post type-post status-publish format-standard has-post-thumbnail hentry category-logistic tag-advance tag-blog tag-business tag-cargo tag-carriage tag-cars">
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-content">
                                        <div class="post-image"> <router-link to="/blog" title="Trucking Market On Solid Footing Early Into 2016"> <img width="800" height="535" :src="blog.image" class="attachment-translogistic-blog-post-image size-translogistic-blog-post-image wp-post-image" alt=""> </router-link></div>
                                    ...
                                    <div class="post-bottom"> <a href="#" title="Trucking Market On Solid Footing Early Into 2016" class="more" @click="showBlog(blog)">More</a>
                                        <div class="post-share">
                                            <ul>
                                                <li><a class="share-facebook" href="#" title="Share toFacebook" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
