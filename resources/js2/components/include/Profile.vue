...
<div class="text-xs-center">
    <v-menu v-model="menu" :close-on-content-click="false" :nudge-width="200" offset-y transition="slide-y-transition" v-if="user">
        ...
        <v-card>
            <v-list>
                <v-list-tile avatar>
                    <v-list-tile-avatar>
                        ...
                        <div class="imagecontainer">
                            <img :src="user.profile" alt="user.name" class="image">
                ...
                <v-divider></v-divider>
                <a href="/admin#/Shipments" target="_blank" class="v-list__tile v-list__tile--link">
